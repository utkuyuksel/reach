...
- **v1.7 — LiveOps temeli (F2P denetiminin uygulanması).** `_spec/design-audit-2026-06.md`'deki Faz 1+2 ve Faz 3'ün büyük kısmı tek sürümde:
  ...
  - 4 yeni test dosyası/grubu: streak (freeze/repair/saat/madalya), ekonomi (starter/exclusive/kota/hediye/eğri), controller (finale/bölüm/chain/arşiv). Tüm suite yeşil.
